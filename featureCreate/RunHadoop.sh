...
hadoop pipes -D hadoop.pipes.java.recordreader=true -D hadoop.pipes.java.recordwriter=true -D mapred.reduce.tasks=2 -files data/testingKeyword,data/languageBase/specialWordLib,data/languageBase/languageRule,data/totalLawInfo -input /user/hsng/inputFile/ -output /user/hsng/output -program /user/hsng/bin/wordcount
